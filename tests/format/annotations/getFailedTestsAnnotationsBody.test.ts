...
describe('getFailedTestsAnnotationsBody', () => {
    it('should return failed tests annotations body', () => {
        expect(
            ...
            .toBe(`Created failed tests' annotations. To disable them, see [documentation](https://github.com/the-homeless-god/jest-coverage-report-action#jest-coverage-report-).
Failures`);
    });
});
